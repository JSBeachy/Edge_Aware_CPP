...
class AppWindow:
    ...
    def __init__(self, width, height):
        ...
        em = w.theme.font_size #keep font size proportional to settings panel size
        ...
        #creating two rows of buttons, stretch extends all the way out
        ...
        # Set layout above scene (with _on_layout callback)

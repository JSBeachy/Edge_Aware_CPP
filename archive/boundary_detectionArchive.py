...
from PCAClassArchive import PCABounding, Best_Fit_CPP
import time
import math
...
#boundary=segment.boundary_edge_finder() #works but is 4x faster
...
#print(primary_edge,secondary_edge)
group1=segment.splitting(primary_edge, hull_vertices_list)
group2=segment.splitting(secondary_edge, hull_vertices_list)
#print(f"group1 points: {group1}")
#print(f"group2 points: {group2}")

#plt.figure
#plt.plot(group1[:,0],group1[:,1], label="Edge 1")
#plt.plot(group2[:,0],group2[:,1], label="Edge 2")
#plt.legend()
#plt.show()
...
#Bezier Curve Stuff
# curve_points1= segment.fit_curve3d(group1)
# curve_points2= segment.fit_curve3d(group2)

# line_points1=curve_points1
# line_points2=curve_points2
...
print(f"total time for checking: {end-s2}")
